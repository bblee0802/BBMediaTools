...
// BBMediaToolsDlg.cpp : implementation file
//
...
CBBMediaToolsDlg::CBBMediaToolsDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_BBMEDIATOOLS_DIALOG, pParent)
{
...
// CBBMediaToolsDlg message handlers

BOOL CBBMediaToolsDlg::OnInitDialog()
{
...
void CBBMediaToolsDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CBBMediaToolsDlg::OnQueryDragIcon()
{
...
void CBBMediaToolsDlg::OnBnClickedOk()
{
...
void CBBMediaToolsDlg::OnBnClickedCancel()
{
	// TODO: Add your control notification handler code here
	CDialogEx::OnCancel();
}
